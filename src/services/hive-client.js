...
const DID='did:hive:hiveforce-referral';const ID={name:'HiveForce-Referral',purpose:'Viral referral engine — reward tiers, attribution tracking, network growth campaigns',capabilities:["referral_tracking","reward_tiers","attribution","growth_campaigns"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-referral-agent',purpose:ID.purpose})}
